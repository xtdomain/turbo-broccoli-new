...
+ подключение реализовано в родительском классе Model, созданые модели должны заканчиваться на ...Model.php
...
+ В модели можно быстро получить информацию из БД, в скобках указываются:
  + $table - имя таблицы,
